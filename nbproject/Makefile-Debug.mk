...
${OBJECTDIR}/e6_myClass.o: e6_myClass.C 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../PYTHIA/pythia8175/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/e6_myClass.o e6_myClass.C

${OBJECTDIR}/e6_Class.o: e6_Class.C 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../PYTHIA/pythia8175/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/e6_Class.o e6_Class.C

${OBJECTDIR}/mergeROOTFiles.o: mergeROOTFiles.C 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../PYTHIA/pythia8175/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/mergeROOTFiles.o mergeROOTFiles.C
...
${OBJECTDIR}/e6_rootMacro1vTree.o: e6_rootMacro1vTree.C 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../PYTHIA/pythia8175/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/e6_rootMacro1vTree.o e6_rootMacro1vTree.C
