...
void e6_GenParticleTrees(const char *inputFile) {
    ...
    TTree *t_deneme=new TTree("adasd", "asdsada");
    TTree t_deneme2("qeqweq", "tryte");
    initializeTTree4GenParticle(t_deneme,&pt_Z,"pt_Z/D");
    initializeTTree4GenParticle(t_deneme2,&pt_Z,"pt_Z/D");
