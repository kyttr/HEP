...
#ifdef e6_Class_cxx
e6_Class::e6_Class(TTree *tree) : fChain(0) 
{
...
Int_t e6_Class::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t e6_Class::LoadTree(Long64_t entry)
{
...
void e6_Class::Show(Long64_t entry)
{
...
Int_t e6_Class::Cut(Long64_t entry)
{
