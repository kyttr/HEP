...
// Wed Apr 17 22:16:25 2013 by ROOT version 5.34/00
// from TTree Delphes/Analysis tree
// found on file: main42hepMC_E6_v3_by_delphes.root
//////////////////////////////////////////////////////////

#ifndef e6_v3_Class_h
#define e6_v3_Class_h
...
#ifdef e6_v3_Class_cxx
e6_v3_Class::e6_v3_Class(TTree *tree) : fChain(0) 
{
...
e6_v3_Class::~e6_v3_Class()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t e6_v3_Class::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t e6_v3_Class::LoadTree(Long64_t entry)
{
...
void e6_v3_Class::Init(TTree *tree)
{
...
void e6_v3_Class::Show(Long64_t entry)
{
...
Int_t e6_v3_Class::Cut(Long64_t entry)
{
